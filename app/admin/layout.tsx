...
import { LayoutDashboard, FileText, Calendar, ImageIcon, LogOut, Mail, MessageSquare, HeartHandshake, PlayCircle } from "lucide-react"
...
const adminNav = [
    ...
    { label: "Sermons", href: "/admin/sermons", icon: PlayCircle },
    { label: "Feedback", href: "/admin/feedback", icon: MessageSquare },
    { label: "Pledges", href: "/admin/pledges", icon: HeartHandshake },
]
